...
# Features
- **[FluentGridFilter](#fluentgridfilter-component):** Filters grid data by numeric, text, and date values.
- **[FluentGridTextFilter](#fluentgridtextfilter-component):** Filters text data containing the specified value.
